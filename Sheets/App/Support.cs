...
namespace Sheets.App
{
    internal static class Support
    {
        ...
        internal static BlockReference RecreateSheetBlock(ViewportData data, BlockTableRecord btr, BlockTable bt, Transaction tr, double textHeight, double scale)
        {
            ...
            //добавляем подложку
            BlockReference background = new BlockReference(btr.Origin, btr.Id) { Layer = AppConstants.SheetsLayer, ColorIndex = 256, LineWeight = LineWeight.ByLayer };
            ...
            curve.Layer = AppConstants.CurrentObjectsLayer;
            ...
            MText number = new MText()
            {
                ...
                Layer = AppConstants.BackgroundSheetsLayer,
                ColorIndex = 256,
            ...
            if (!string.IsNullOrEmpty(number.Text))
            {
                ...
                nClone.Layer = AppConstants.CurrentObjectsLayer;
                ...
                //добавляем круг
                circle = new Circle(center, Vector3d.ZAxis, radius > textHeight ? radius : textHeight) { Layer = AppConstants.CurrentObjectsLayer, ColorIndex = 256, LineWeight = LineWeight.ByLayer };
            ...
            hatch.Layer = AppConstants.CurrentObjectsLayer;
